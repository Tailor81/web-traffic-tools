...
marketing_app.layout = html.Div([
    html.Div([
        html.Div([
            ...
            html.Div(id="total-revenue", className="metric-value")
        ], className="metric-card"),
        html.Div([
            html.H5("Total Units Sold"),
            html.Div(id="total-units", className="metric-value")
        ], className="metric-card"),
        html.Div([
            html.H5("Total Transactions"),
            html.Div(id="total-transactions", className="metric-value")
        ], className="metric-card"),
        html.Div([
            html.H5("Average Order Value"),
            html.Div(id="avg-order-value", className="metric-value")
        ], className="metric-card"),
    ], className="row"),
    html.Div([
        html.Div([
            dcc.Graph(id="revenue-category-chart")
        ], className="chart-container"),
        html.Div([
            dcc.Graph(id="revenue-product-chart")
        ], className="chart-container"),
    ], className="row"),
    html.Div([
        html.Div([
        ...
        html.Div([
            dcc.Graph(id="clv-acquisition-chart")
        ], className="chart-container"),
    ], className="row"),
])
...
@marketing_app.callback(
    [Output('total-revenue', 'children'),
     ...
     Output('revenue-category-chart', 'figure'),
     Output('revenue-product-chart', 'figure'),
     Output('customer-segment-chart', 'figure'),
     Output('clv-acquisition-chart', 'figure')],
    [Input('date-range', 'value')]
)
def update_marketing_dashboard(date_range):
